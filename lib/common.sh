...
DOTFORGE_SECRETS_STORE=${DOTFORGE_SECRETS_STORE:-"$DOTFORGE_ROOT/secrets/store.tsv.age"}
...
DOTFORGE_AGE_PASSPHRASE_VALIDATED=${DOTFORGE_AGE_PASSPHRASE_VALIDATED:-0}
DOTFORGE_SUDO_KEEPALIVE_PID=${DOTFORGE_SUDO_KEEPALIVE_PID:-""}
DOTFORGE_CURRENT_SHELL=${DOTFORGE_CURRENT_SHELL:-""}
DOTFORGE_LOGIN_SHELL=${DOTFORGE_LOGIN_SHELL:-""}
DOTFORGE_RUNTIME_SECRETS_STORE=${DOTFORGE_RUNTIME_SECRETS_STORE:-""}
...
DOTFORGE_LOCAL_SECRETS_DIR="$DOTFORGE_STATE_DIR/secrets"
