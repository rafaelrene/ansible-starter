# PATHS
export PATH="$HOME/.local/share/dotforge/bin:$PATH" # managed by dotforge
export VOLTA_HOME="$XDG_CONFIG_HOME/volta"
export DIVERSION_HOME="$XDG_CONFIG_HOME/diversion"
export PNPM_HOME="$XDG_CONFIG_HOME/pnpm"
export GOPATH="$XDG_CONFIG_HOME/go"
export SPIN_HOME="$HOME/.spin"
export HOMEBREW_HOME="${HOMEBREW_HOME:-$(command -v brew >/dev/null 2>&1 && brew --prefix || printf '')}"
...
[[ -n "$HOMEBREW_HOME" ]] && export PATH="$HOMEBREW_HOME/bin:$PATH"
